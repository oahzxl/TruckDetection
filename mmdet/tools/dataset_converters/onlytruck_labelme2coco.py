...
class labelme2coco(object):
    ...
    def data_transfer(self):
        for num, json_file in tqdm.tqdm(enumerate(self.labelme_json), total=len(self.labelme_json)):
            with open(json_file, "r") as fp:
                ...
                try:
                    ...
                    self.error_count += 1
                    print("Loading error %d : %s" % (self.error_count, data["imagePath"]))
                    continue
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default="/home/zxl/TruckDetection/data/origin/train"
    )
    parser.add_argument(
